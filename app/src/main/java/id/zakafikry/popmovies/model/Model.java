package id.zakafikry.popmovies.model;
...
import id.zakafikry.popmovies.entity.Review;
import id.zakafikry.popmovies.entity.Video;
import id.zakafikry.popmovies.event.DataBusProvider;
import id.zakafikry.popmovies.event.events.ApiErrorEvent;
import id.zakafikry.popmovies.event.events.CancelAllEvent;
import id.zakafikry.popmovies.event.events.LoadMovieEvent;
import id.zakafikry.popmovies.event.events.LoadMoviesEvent;
import id.zakafikry.popmovies.event.events.MovieLoadedEvent;
import id.zakafikry.popmovies.event.events.MovieUpdatedEvent;
import id.zakafikry.popmovies.event.events.MoviesLoadedEvent;
import id.zakafikry.popmovies.event.events.UpdateMovieEvent;
import id.zakafikry.popmovies.util.AppUtil;
...
public class Model {
    ...
    public Model() {
        ...
        mApiKey = "889f55f53ce525ee7d7ed9ffa0f5c3c1";
